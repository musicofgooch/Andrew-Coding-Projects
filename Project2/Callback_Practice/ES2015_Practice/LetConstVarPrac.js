...
travelDare = "2024-04-01";

/*
 * Observations:
 * TODO: Explain here.
 *  This causes an error because `travelDate` is constant and can't be reassigned.
 */
 ...
 * Observations:
 * TODO: Explain here.
 * This prints `undefined` because of variable hoisting. The declaration is hoisted to the top, but its assignment happens where it should be declared.
 */